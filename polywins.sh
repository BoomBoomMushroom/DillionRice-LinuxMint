...
# FROM : https://github.com/uniquepointer/polywins

# SETTINGS {{{ ---

active_text_color="#ff98ec"
active_bg=
active_underline="#ECB3B2"

inactive_text_color="#ffb0f4"
inactive_bg=
inactive_underline=

seperator_color="#707880"
separator="|"
...
inactive_right="%{F-}"
separator="%{F$seperator_color}$separator%{F-}"
...
generate_window_list() {
	...
	while IFS="[ .\.]" read -r wid ws cname cls host title; do
		...
		# Change common names into human readable stuff
		case "$cls" in
			*Gnome-terminal*)
				cls="Terminal"
				;;
